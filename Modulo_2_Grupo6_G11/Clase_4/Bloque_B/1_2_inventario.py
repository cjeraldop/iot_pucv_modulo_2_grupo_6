...
print("El Valor total en Bodega es de: ", valor_total_bodega(productos), 'pesos')
print("El Ingreso Total por ventas es de: ", ingreso_total_por_ventas(itemes,productos), 'pesos')
